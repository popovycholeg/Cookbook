...
import withHocs from './RecipeDialogHoc';

class RecipeDialog extends React.Component { // TODO: functional

  handleDelete = () => {
    const { id, handleClose, deleteRecipe } = this.props;
    deleteRecipe(id);
    handleClose();
  }
...
export default withHocs(RecipeDialog);
